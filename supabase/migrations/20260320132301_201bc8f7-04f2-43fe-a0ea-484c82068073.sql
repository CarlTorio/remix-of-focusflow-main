...
BEGIN
  ...
  -- Seed example main task (project with subtasks)
  INSERT INTO public.tasks (id, user_id, title, description, due_date, priority, kind, estimated_hours, icon_emoji, icon_color)
  VALUES (
    gen_random_uuid(),
    NEW.id,
    'My First Project',
